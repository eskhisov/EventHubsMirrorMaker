...
then
    ...
    kafka-producer-perf-test --topic $topic --payload-file /mnt/EventHubsMirrorMaker/ehmirror/user.json --producer.config perf.producer.config  --throughput $rate --num-records $count
else
